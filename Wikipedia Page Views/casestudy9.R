...
#Which language has the largest number of view? (please create a histogram of the top
#10 languages)
...
#Top 10 languages with largest number of views
...
top10_pageviews = head(arrange(view_count,desc(views)), n = 10)
